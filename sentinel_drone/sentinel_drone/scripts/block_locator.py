...
class Edrone():
	def __init__(self, f):
		...
		rospy.init_node('drone_control',disable_signals=False)	# initializing ros node with name drone_control
		...
		self.Kp = [25.6,25.6,33.5]
		self.Ki = [0,0,0.0] #197
		self.Kd = [1400,1400,900] #1223
...
if __name__ == '__main__':
	...
	time.sleep(6)
	while not rospy.is_shutdown() and e_drone.img_counter<3:
		e_drone.pid()
		r.sleep()
	f.close()
